    ...
    <div class="site-content__wrapper">
      <div class="site-content">
        <div class="brand-info">
          ...
          <p class="brand-info__intro">xtoon-cloud是一款基于DDD领域模型<br>并支持SaaS的微服务框架</p>
        </div>
        <div class="login-main">
          <h3 class="login-title">登录</h3>
          <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" status-icon>
            <el-form-item prop="accountName">
              <el-input v-model="dataForm.accountName" placeholder="帐号"></el-input>
            </el-form-item>
            ...
            <div class="tl">
              <span>还没有账号？</span>
              <el-button @click="$router.push({name:'register'})">立即注册</el-button>
            </div>
            <div class="tl" style="margin-top: 10px;">
              <span>演示账号：18555555555/123456</span>
            </div>
          </el-form>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
          ...
          if (valid) {
            this.$http({
              ...
              params: this.$http.adornParams({
                'username': this.dataForm.accountName,
      ...
      getCaptcha () {
        ...
        this.captchaPath = this.$http.adornUrl(`/sys/captcha?uuid=${this.dataForm.uuid}`)
      }
    }
  }
</script>
